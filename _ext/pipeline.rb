...
Awestruct::Extensions::Pipeline.new do
  ...
  transformer Awestruct::Extensions::JsMinifier.new if site.js_minifier == 'enabled'
  transformer Awestruct::Extensions::CssMinifier.new if site.css_minifier == 'enabled'
